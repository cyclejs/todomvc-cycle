...
},{"rx":63}],2:[function(require,module,exports){
"use strict";
...
},{"./fromevent":3,"./transposition":7,"./virtual-hyperscript":8,"matches-selector":10,"rx":63,"vdom-parser":11,"virtual-dom/diff":26,"virtual-dom/patch":33}],6:[function(require,module,exports){
"use strict";
...
},{"./transposition":7,"rx":63,"vdom-to-html":15}],7:[function(require,module,exports){
"use strict";
...
},{"rx":63,"virtual-dom/vnode/vnode":54}],8:[function(require,module,exports){
/* eslint-disable */
'use strict';
...
},{"./components/Todos/index":66,"./drivers":72,"@cycle/core":1,"@cycle/dom":2,"rx":63}],65:[function(require,module,exports){
'use strict';
...
function intent(DOM) {
  return _rx.Observable.merge(DOM.select('.destroy').events('click').map(function () {
    return { type: 'destroy' };
  }), DOM.select('.toggle').events('change').map(function () {
    return { type: 'toggle' };
  }), DOM.select('label').events('dblclick').map(function () {
    return { type: 'startEdit' };
  }), DOM.select('.edit').events('keyup').filter(function (ev) {
    ...
    return { title: ev.currentTarget.value, type: 'doneEdit' };
  })).share();
}

function model(props$, action$) {
  var sanitizedProps$ = props$.startWith({ title: '', completed: false });
  var editing$ = _rx.Observable.merge(action$.filter(function (a) {
...
},{"../utils":73,"@cycle/dom":2,"rx":63}],66:[function(require,module,exports){
'use strict';
...
function Todos(_ref) {
  ...
  var state$ = (0, _model2['default'])(actions, sourceTodosData$);
...
},{"../TodoItem":65,"./intent":67,"./local-storage-sink":68,"./local-storage-source":69,"./model":70,"./view":71,"@cycle/isolate":60,"rx":63}],67:[function(require,module,exports){
'use strict';
...
},{"../../utils":73,"rx":63}],68:[function(require,module,exports){
"use strict";
...
},{"rx":63}],71:[function(require,module,exports){
'use strict';
...
},{"@cycle/dom":2}],72:[function(require,module,exports){
'use strict';
...
},{"rx":63}],73:[function(require,module,exports){
"use strict";
